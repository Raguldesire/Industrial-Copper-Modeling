...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r".venv/model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r'.venv/scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r".venv/t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r".venv/s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r".venv/clsmodel (1).pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r'.venv/cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r".venv/ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Ragul S</h6>', unsafe_allow_html=True)
